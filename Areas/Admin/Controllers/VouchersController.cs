...
namespace uit_project_framework.Areas.Admin.Controllers
{
    ...
    public class VouchersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VoucherId,VoucherCode,Money,Status,CreatedAt,UpdatedAt")] Voucher voucher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VoucherId,VoucherCode,Money,Status,CreatedAt,UpdatedAt")] Voucher voucher)
        {
